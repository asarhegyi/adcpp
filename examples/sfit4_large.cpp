/************************************************************
* sfit4_large -- program to do a 4 parameter sine-wave fit  *
...
*                                                           *
* Example:                                                  *
*        sfit4_large -f1000.0445712 -s500000 -r0 \          *
*        ../charData/test.int                               *
*                                                           *
************************************************************/
#include <stdio.h>
...
int main (int argc, char *argv[])
{
    ...
    ************************************************************/
    ...
    mysfit.sfit4_large(inputFile, frequency, nofHarmonics, fSample, blockSize);
