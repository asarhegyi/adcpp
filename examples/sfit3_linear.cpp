/************************************************************
* sfit3_linear -- program to do a 3 parameter sine-wave fit *
*        using the gsl_multifit_linear function. Note that  *
*        this is a single step algorithm. There is no need  *
*        to do an initial estimate of the coefficients.     *
*                                                           *
...
*                                                           *
* Example:                                                  *
*        sfit3_linear -f1000.0445712 -s500000 -r0 \         *
*        ../charData/test.int                               *
*                                                           *
************************************************************/
#include <stdio.h>
...
int main (int argc, char *argv[])
{
    ...
    ************************************************************/
    ...
    mysfit.sfit3_linear(inputFile, frequency, nofHarmonics, fSample);
